...
bool Mesh::checkElementArray() const { return !indices.empty(); }
unsigned int Mesh::getIndices()  const { return indices.size(); }
unsigned int Mesh::getVertices() const { return vertices.size(); }
